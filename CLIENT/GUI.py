...
"}")
        ...
        self.lineEdit = QtWidgets.QTextEdit(self.frame) # lineEdit
...
"}")
        ...
        self.listWidget_2.setGeometry(QtCore.QRect(5, 11, 261, 391))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.listWidget.setWordWrap(True) #Changed
        self.listWidget.setHorizontalScrollBarPolicy(1) #changed
